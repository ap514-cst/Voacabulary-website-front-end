...
//http://localhost:2002/api/data/vocGET/level?level=intermediate
...
const IntermediateList = () => {
  ...
  const fetchWords = async () => {
    try {
      setLoading(true);
      const response = await fetch("https://voacabulary-website-back-end-2.onrender.com/api/data/vocGET/level?level=intermediate");
